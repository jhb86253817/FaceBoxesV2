...
import datetime
import math
from models.faceboxes import FaceBoxes, FaceBoxesV2
...
net = FaceBoxesV2('train', img_dim, num_classes)
print("Printing net...")
print(net)
...
def train():
    ...
    for iteration in range(start_iter, max_iter):
        if iteration % epoch_size == 0:
            ...
            if (epoch % 10 == 0 and epoch > 0) or (epoch % 5 == 0 and epoch > 200):
                torch.save(net.state_dict(), save_folder + 'FaceBoxesV2_epoch_' + str(epoch) + '.pth')
            epoch += 1
    ...
    torch.save(net.state_dict(), save_folder + 'Final_FaceBoxesV2.pth')
